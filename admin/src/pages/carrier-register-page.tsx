  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 text-white">
      <div className="w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-8">
        ...
        <h1 className="mt-4 text-3xl font-bold">Carrier register</h1>
        <p className="mt-2 text-sm text-slate-400">
          M4 — transport company account, then OTP login to continue.
        </p>
        ...
        >
          <div>
            <label className="mb-1.5 block text-sm">Company / contact name</label>
          ...
          >
            {mutation.isPending ? 'Creating…' : 'Create carrier account'}
          </button>
        </form>
