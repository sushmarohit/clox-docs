...
export function HomeFaq({ copy }: { copy: HomeCopy }) {
  ...
  return (
    <section id="faq" className="scroll-mt-[9.5rem] bg-clox-surface px-5 py-12 sm:scroll-mt-28 sm:px-8 sm:py-24">
      <div className="mx-auto max-w-[800px] 2xl:max-w-[900px] 3xl:max-w-[1000px]">
