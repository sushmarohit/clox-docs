  ...
  return (
    <header className="fixed inset-x-0 top-0 z-[1000] border-b border-slate-200/80 bg-white/95 shadow-[0_4px_24px_rgba(10,31,60,0.08)] backdrop-blur-[12px]">
      <div className="bg-clox-navy px-4 py-2.5 sm:px-6">
        <p className="clox-container px-0 text-center text-[0.7rem] font-semibold leading-relaxed tracking-wide text-white sm:text-[0.8rem] 3xl:text-[0.9rem]">
      ...
      <div className="clox-container flex items-center gap-4 px-4 py-3 sm:gap-5 sm:px-6 sm:py-3.5 lg:gap-6 xl:px-8 3xl:gap-8">
            ...
            if (isNavGroup(item)) {
              return (
                <NavDropdown
                  key={item.label}
                  item={item}
                  linkClassName="clox-nav-link whitespace-nowrap text-[0.8rem] xl:text-[0.9rem] 2xl:text-[0.98rem] 3xl:text-[1.05rem]"
                />
              );
            }
