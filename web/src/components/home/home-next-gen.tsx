...
export function HomeNextGen({ copy }: { copy: HomeCopy }) {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[280px] max-w-4xl flex-col items-center justify-center sm:min-h-[320px] 2xl:max-w-5xl 3xl:min-h-[380px] 3xl:max-w-6xl">
