...
const copy = {
  ...
  pa: {
    ...
    slide1Body:
      'CLOX ਆਸਟ੍ਰੇਲੀਆ ਦਾ ਵਿਕੇਂਦਰੀਕ੍ਰਿਤ, ਆਟੋਮੇਟਡ 4PL ਡਿਜੀਟਲ ਇਕੋਸਿਸਟਮ ਹੈ ਜੋ ਕਾਰਪੋਰੇਟ ਸੈਂਡਰਾਂ ਨੂੰ ਸਿੱਧੇ ਜਾਂਚੇ ਹੋਏ ਭਾਰੀ ਵਾਹਨ ਓਪਰੇਟਰਾਂ ਅਤੇ ਟਰਾਂਸਪੋਰਟ ਫਲੀਟ ਨਾਲ ਜੋੜਦਾ ਹੈ — ਰਵਾਇਤੀ ਬ੍ਰੋਕਰ ਅਤੇ ਲੁਕਵੇਂ ਮਾਰਜਿਨ ਤੋਂ ਬਿਨਾਂ।',
    slide2TitleLead: 'ਆਪਣਾ ਮਾਲ ਭੇਜੋ',
    slide2TitleAccent: 'ਤੇਜ਼ ਅਤੇ ਸੁਰੱਖਿਅਤ',
    slide2Body:
      'ਸਮਾਰਟ ਫਰੇਟ ਫਾਰਵਰਡਿੰਗ — ਸਰਲ, ਪਾਰਦਰਸ਼ੀ ਅਤੇ ਕੁਸ਼ਲ। ਗੁੰਝਲਦਾਰ ਫਾਰਮ ਜਾਂ ਅਨਗਿਣਤ ਕਾਲਾਂ ਦੀ ਲੋੜ ਨਹੀਂ — ਸਿਰਫ਼ ਉਹ ਜ਼ਰੂਰੀ ਚੀਜ਼ਾਂ ਜੋ ਮਾਲ ਨੂੰ ਤੇਜ਼, ਸਸਤਾ ਅਤੇ ਸੁਰੱਖਿਅਤ ਭੇਜਣ ਲਈ ਚਾਹੀਦੀਆਂ ਹਨ।',
    slide3TitleLead: 'ਬਿਨਾਂ ਰੁਕਾਵਟ ਦਾ',
    slide3TitleAccent: 'ਫਰੇਟ ਤਜਰਬਾ',
    slide3Body:
      'ਇੱਕ ਜੁੜਿਆ ਫਰੇਟ ਤਜਰਬਾ ਜੋ ਮੈਨੂਅਲ ਹੈਂਡਆਫ ਘਟਾਉਂਦਾ ਹੈ, ਦ੍ਰਿਸ਼ਤਾ ਵਧਾਉਂਦਾ ਹੈ, ਅਤੇ ਆਸਟ੍ਰੇਲੀਅਨ ਸੈਂਡਰ ਤੇ ਟਰਾਂਸਪੋਰਟ ਓਪਰੇਟਰਾਂ ਨੂੰ ਆਤਮਵਿਸ਼ਵਾਸ ਨਾਲ ਅੱਗੇ ਵਧਾਉਂਦਾ ਹੈ।',
    slide4TitleLead: 'ਇੱਕ ਜੁੜਿਆ',
    slide4TitleAccent: 'ਫਰੇਟ ਇਕੋਸਿਸਟਮ',
    slide4Body:
      'CLOX ਕਾਰਪੋਰੇਟ ਸੈਂਡਰ, ਜਾਂਚੇ ਹੋਏ ਕੈਰੀਅਰ, ਪਾਰਦਰਸ਼ੀ ਬਿਡਿੰਗ, ਟ੍ਰੈਕਿੰਗ ਅਤੇ ਸੁਰੱਖਿਅਤ ਭੁਗਤਾਨ ਨੂੰ ਇੱਕ ਸੁਵਿਧਾਜਨਕ ਡਿਜੀਟਲ ਯਾਤਰਾ ਵਿੱਚ ਲਿਆਉਣ ਲਈ ਬਣਾਇਆ ਜਾ ਰਿਹਾ ਹੈ।',
    ...
    nextBody:
      'CLOX ਸਵੈਚਾਲਿਤ 4PL ਲੌਜਿਸਟਿਕਸ ਦੀ ਅਗਲੀ ਪੀੜ੍ਹੀ ਹੈ। ਵਿਕੇਂਦਰੀਕ੍ਰਿਤ, ਆਟੋਮੇਟਡ ਡਿਜੀਟਲ ਇਕੋਸਿਸਟਮ ਰਾਹੀਂ ਇਹ ਮੁਕਾਬਲੇਬਾਜ਼ ਕੀਮਤ ਚਾਹੁਣ ਵਾਲੇ ਸ਼ਿਪਰਾਂ ਅਤੇ ਅਸੈਟ ਵਰਤੋਂ ਵਧਾਉਣ ਵਾਲੇ ਕੈਰੀਅਰਾਂ ਵਿਚਕਾਰ ਪੁਲ ਬਣਾਉਂਦਾ ਹੈ। ਸਾਡੀ ਤਕਨੀਕ ਰਵਾਇਤੀ ਘਰਸ਼ਣ ਲਾਗਤ ਹਟਾਉਂਦੀ ਹੈ ਅਤੇ ਕੰਟਰੋਲ, ਗਤੀ ਤੇ ਦ੍ਰਿਸ਼ਤਾ ਵਾਪਸ ਕਾਰੋਬਾਰਾਂ ਨੂੰ ਦਿੰਦੀ ਹੈ।',
    ...
    carrierSpotBody:
      'CLOX ਇਕੋਸਿਸਟਮ ਦੇ ਸਪਲਾਈ ਸਾਈਡ ਵਿੱਚ ਤੁਹਾਡਾ ਸੁਆਗਤ ਹੈ — ਜਿੱਥੇ ਪੈਸੇ ਲਾਕ ਹੋਣ ਤੱਕ ਪਹੀਏ ਨਹੀਂ ਚੱਲਦੇ। CLOX Stripe Connect ਉੱਤੇ ਅਧਾਰਿਤ 100% ਅਪਫ੍ਰੰਟ ਐਸਕ੍ਰੋ ਸੁਰੱਖਿਆ ਇੰਫਰਾਸਟਰਕਚਰ ਉੱਤੇ ਬਣਾਇਆ ਜਾ ਰਿਹਾ ਹੈ ਤਾਂ ਜੋ ਲੋਡਿੰਗ ਤੋਂ ਪਹਿਲਾਂ ਫੰਡ ਸੁਰੱਖਿਅਤ ਹੋਣ ਅਤੇ ਸਫਲ ਡਿਲੀਵਰੀ ਤੋਂ ਬਾਅਦ ਜਾਰੀ ਹੋਣ।',
