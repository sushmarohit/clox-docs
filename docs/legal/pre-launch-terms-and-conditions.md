...
| Source | `CLOX_Pre-Launch_Terms_And_Conditions_v1.pdf` |

**Related:** [pre-launch-privacy-policy.md](pre-launch-privacy-policy.md) · [global-legal-framework.md](global-legal-framework.md)
...
2. [Operator Details](#2-operator-details)
3. [Pre-Launch Registration & Waitlist](#3-pre-launch-registration--waitlist)
4. [Intellectual Property Rights](#4-intellectual-property-rights)
5. [Acceptable Use of the Website](#5-acceptable-use-of-the-website)
6. [Third-Party Links & Content](#6-third-party-links--content)
7. [Disclaimers & Limitation of Liability](#7-disclaimers--limitation-of-liability)
8. [Indemnity](#8-indemnity)
9. [Governing Law & Jurisdiction](#9-governing-law--jurisdiction)
...
- **Future Features:** Descriptions of the CLOX platform (including algorithmic pricing, Valhalla routing, and Stripe Connect escrow integrations) represent our development roadmap and are subject to change without notice prior to the official launch.
